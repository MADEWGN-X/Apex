...
async def menu(event):
	inline = [
[Button.inline(" MANAGER SSH OVPN","ssh")],
[Button.inline(" MANAGER VMESS","vmess"),
Button.inline(" MANAGER VLESS ","vless")],
[Button.inline(" MANAGER TROJAN","trojan"),
Button.inline(" MANAGER SHDWSK ","shadowsocks")],
